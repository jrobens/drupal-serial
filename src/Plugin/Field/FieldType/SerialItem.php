 ...
 * )
 */
class SerialItem extends FieldItemBase  { // implements ContainerFactoryPluginInterface  {

  /**
   * Constructs a StringFormatter instance.
   *
   * @param \Drupal\Core\Field\FieldDefinitionInterface  $plugin_id
 ...
 /* public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
  ...
  public function preSave() {
    ...
    // Execute a serial save event
    /** @var \Drupal\serial\Event\SerialEventDispatcherInterface $manager */
    $manager = \Drupal::service('serial.event_manager');
    $manager->register(new SerialSetEvent($value, $this->getEntity()));
  }
